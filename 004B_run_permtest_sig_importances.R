...
if(!is.na(signature)){
	...
	dir.create(paste0(pff("data/004B_Sig_importance_permRF_results/"), project_code, "/"))

	fwrite(RF_results, paste0(pff("data/004B_Sig_importance_permRF_results/"), project_code, "/" ,signature, ".csv"))
