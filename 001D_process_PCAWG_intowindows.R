...
fwrite(process_muts(1000000), pff("data/001D_PCAWG_mutation_counts_1MBwindow_processed.csv"))
fwrite(process_muts(100000), pff("data/001D_PCAWG_mutation_counts_100KBwindow_processed.csv"))