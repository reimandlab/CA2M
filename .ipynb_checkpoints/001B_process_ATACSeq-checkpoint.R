...
fwrite(process_atacseq(1000000), pff("/data/001B_TCGA_ATACSeq_1MBwindow_processed.csv"))
fwrite(process_atacseq(100000), pff("/data/001B_TCGA_ATACSeq_100KBwindow.csv"))
